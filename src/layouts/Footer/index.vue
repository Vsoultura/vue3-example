...
<template>
  ...
  >
    <div
      class="flex w-full max-w-6xl flex-row items-center justify-between gap-6"
    >
      <a
      ...
      <div class="flex flex-col items-center gap-4 text-left sm:flex-row">
        <div class="flex gap-4 pb-4">
          ...
          >
            <h3 class="p-2 text-xs font-bold text-base-content/50">
              viteBoot™
            </h3>
            <p
              class="px-1.5 py-2 text-xs tracking-tighter text-base-content/50"
            >
              All Rights Reserved.
            </p>
          </a>
